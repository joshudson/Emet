...
namespace Emet.FileSystems {
	...
	///<summary>Interface for file system access; by default a disk but could wrap arbitary network file access</summary>
	public interface IVirtualFileSystem : IDisposable {
		...
		IVirtualFileSystem CreateChild(string path);
	...
	public static class VirtualFileSystemExtensions {
		...
		///<exception cref="System.IO.IOException">an error occured opening the path</exception>
		///<exception cref="System.InvalidOperationException">A system constraint was found to be violated while descending the directory tree</exception>
		public static IEnumerable<DirectoryEntry>? GetDirectoryContentsOrNull(this IVirtualFileSystem @this, string path)
		...
		///<exception cref="System.IO.IOException">an error occured opening the path</exception>
		///<exception cref="System.InvalidOperationException">A system constraint was found to be violated while descending the directory tree</exception>
		public static IEnumerable<DirectoryEntry> GetDirectoryContentsOrThrow(this IVirtualFileSystem @this, string path)
		...
		///<exception cref="System.IO.IOException">an error occured opening the path</exception>
		///<exception cref="System.InvalidOperationException">A system constraint was found to be violated while descending the directory tree</exception>
		public static IEnumerable<DirectoryEntry> GetDirectoryContentsOrEmpty(this IVirtualFileSystem @this, string path)
		...
		public static string CombinePath(this IVirtualFileSystem @this, params string[] components)
			=> CombinePath(@this, (IEnumerable<string>)components);

		///<summary>Build a path from components, using the context of the IVirtualFileSystem</summary>
		///<param name="this">the IVirtualFileSystem entry to examine</param>
		///<param name="components">the components to join</param>
		public static string CombinePath(this IVirtualFileSystem @this, IEnumerable<string> components)
		{
		...
		public static int GetDirectoryFileSeparationPoint(this IVirtualFileSystem @this, string path)
		{
			if (@this is null) throw new ArgumentNullException(nameof(@this));
		...
		public static string GetDirectoryName(this IVirtualFileSystem @this, string path)
		{
		...
		public static string GetFileName(this IVirtualFileSystem @this, string path)
		{
			int separation = GetDirectoryFileSeparationPoint(@this, path);
